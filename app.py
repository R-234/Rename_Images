...
# def safe_display_image(image, caption=None):
#     """Version-safe image display that works with Streamlit 1.33.0"""
#     try:
#         # Simple display without width parameters
